#copied from /vol/tensusers5/mbentum/lm_martijn/opt/kaldi/egs/wsj/s5/steps/pytorchnn
# taken from pytorch example https://github.com/pytorch/examples/blob/master/word_language_model/model.py
# used by pytorch_lm to train rescore LM
